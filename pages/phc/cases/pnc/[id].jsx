        ...
        <main className="p-6 mt-16 max-w-3xl">
          ...
          <div className="flex justify-between items-start mb-4">
            <div>
              ...
              <p className="text-sm text-gray-500">Case ID: {rec.id} · PNC Case</p>
            </div>
            <Link href="/phc/cases/pnc" className="px-3 py-2 border rounded">Back</Link>
          </div>
          ...
          <div className="bg-white p-4 rounded shadow mb-4">
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <select value={rec.risk_level} onChange={e => saveField("risk_level", e.target.value)} className="w-full p-2 border rounded">
          ...
          <div className="bg-white p-4 rounded shadow mb-4">
            ...
            <textarea className="w-full p-2 border rounded" value={noteText} onChange={e => setNoteText(e.target.value)} placeholder="Add note"></textarea>
            <button onClick={addNote} className="px-3 py-2 bg-blue-600 text-white rounded mt-2">Add Note</button>
          </div>
